...
Data engineer with 4+ years of hands-on Python and data experience — from ingestion
and ETL pipelines to PostgreSQL design and analytics that drive business decisions.
At my last role I built a marketplace price-monitoring pipeline that fed a data-driven
pricing strategy (weekly revenue grew ~3x), and designed the company's first PostgreSQL
database from scratch, replacing Excel workflows for a 20–40 person team.
